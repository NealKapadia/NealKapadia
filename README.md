...
### 🎮 [GenEngine](https://devpost.com/software/genengine) 
**🥇 Winner - Best AI Application Built with Cloudflare, HackRice 15**
> AI-powered tool that converts natural language prompts into playable HTML5 Canvas games
> 
> **Tech:** React, TypeScript, Google Gemini API, Node.js

### 🥷 [Shinobi Self](https://devpost.com/software/shinobi-self)
**🥇 1st Place - NRVE Sponsored Challenge, HackAI 2025**
> Naruto-themed gamified self-improvement app with AI-generated daily missions
> 
> **Tech:** Flutter, OpenAI API, Mobile Development

### 🔬 [DeepSkin](https://devpost.com/software/deepskin)
**AI-Powered Dermatology Assistant**
> Computer vision app for skin condition detection with 67% accuracy using ResNet50
> 
> **Tech:** Python, PyTorch, Flask, Google Maps API
...
![Profile Views](https://komarev.com/ghpvc/?username=NealKapadia&color=blueviolet&style=for-the-badge)
